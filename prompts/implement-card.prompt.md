...
Run the **IMPLEMENT → VERIFY** modes of the investigation approval gate.
...
targeted build/lint/type checks and `diff-review` (and `security-review` when flagged), recording
